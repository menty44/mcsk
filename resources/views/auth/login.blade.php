        ...
        <div class="col-md-6 login-container bs-reset">
            <div class="login-content">
                ...
                <form class="login-form" role="form" method="POST" action="{{ url('/login') }}">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="User Email" name="email" value="{{ old('email') }}" />
                            @if ($errors->has('email'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="rem-password">
                                <p> <a href="{{url('register')}}" id="forget-password" class="forget-password">Register?</a> </p>
                            </div>
                        </div>
